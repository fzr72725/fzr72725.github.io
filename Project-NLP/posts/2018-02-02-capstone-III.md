...
![Feature importance plot](/Project-NLP/images/feature_imp.png)
...
![Partial dependence plot for Japanese and Korean](/Project-NLP/images/jp_ko.png)
...
As mentioned in [part one](2018-02-02-capstone-I.html), I have converted the original essay text into the corresponding syntactic tags as listed below:
**DT_pos_join**
**DT_archs_join**
**DT_insent_pos_ngram**
